...
export const survivalSkillCards = [
  { name: '情境感知', line: '先看见危险，才有资格选择战斗或离开', scene: '夜路、电梯、停车场、陌生邀约' },
  { name: '边界表达', line: '声音先出拳，身体才有时间撤离', scene: '被纠缠、被逼近、关系中的越界' },
  { name: '直拳开路', line: '不是恋战，是打出三步距离', scene: '近距离突围、制造撤离窗口' },
  { name: '地面脱身', line: '摔倒不是终点，站起来才算', scene: '被推倒、被压制、空间被封锁' },
  { name: '随身物品防护', line: '钥匙、包、外套，都是距离管理工具', scene: '临时阻隔、护头护颈、争取呼救' },
  { name: '跑酷撤离', line: '最聪明的胜利，是没人追得上你', scene: '城市逃离、障碍跨越、路线选择' },
  { name: '急救止血', line: '活下来，才有下一次反击', scene: '擦伤、割伤、鼻血、等待救援' },
  { name: '数字求援', line: '手机不是用来沉默的，是用来留下证据的', scene: '行程分享、定位、录音、紧急联系人' },
];
